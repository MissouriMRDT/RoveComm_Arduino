...
bool RoveCommEthernetUDP::read(RoveCommPacket &dest) {
  ...
  _UDPServer.read(rovecomm::_readBuf, packetSize);

  // Read data from buffer into RoveCommPacket
  if (!rovecomm::unpackPacket(dest, rovecomm::_readBuf)) return false;
  ...
  // Unsubscribe Request
    ...
    uint8_t pData[1] = {1};
    this->_writeTo(rovecomm::UINT8_T, RC_ROVECOMM_PING_REPLY_DATA_ID, 1, pData, readIp, RC_ROVECOMM_ETHERNET_UDP_PORT);
  }
  return true;
}

///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void RoveCommEthernetUDP::_write(const rovecomm::data_type_t dataType, const uint16_t dataId, const uint16_t dataCount, const void *data) {
  ...
  size_t sendBytes = rovecomm::packPacket(rovecomm::_writeBuf, dataId, dataCount, dataType, reinterpret_cast<const uint8_t*>(data));
  ...
  for (int i = 0; i < ROVECOMM_ETHERNET_UDP_MAX_SUBSCRIBERS; i++) {
    if (_subscriberIps[i] != INADDR_NONE) {
      ...
      _UDPServer.write(rovecomm::_writeBuf, sendBytes);
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void RoveCommEthernetUDP::_writeTo(const rovecomm::data_type_t dataType, const uint16_t dataId, const uint16_t dataCount, const void *data, const IPAddress ip, const uint16_t port) {
