...
#define ROVECOMM_PACKET_MAX_DATA_COUNT (65535 / 2)// Teensy can only support 32,000 uint8_t at once due to memory issues
#endif
#endif
...
namespace rovecomm {
  ...
  extern uint8_t *_readBuf;
  extern uint8_t *_writeBuf;
