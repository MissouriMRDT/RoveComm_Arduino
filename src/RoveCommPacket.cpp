...
namespace rovecomm {
    ...
    uint8_t *_readBuf = nullptr;
    uint8_t *_writeBuf = nullptr;

    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    //Packs a RoveCommPacket into a byte buffer in network order
    size_t packPacket(uint8_t *dest, const uint16_t dataId, const uint16_t dataCount, const data_type_t dataType, const uint8_t *data) {
        // Pack header
