#include "RoveCommWifiTCP.h"

#if ROVECOMM_ESP32

WifiServer RoveCommWifiTCP::_TCPServer;

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
#define MAX_CLIENTS 8
void RoveCommWifiTCP::begin(const uint16_t port) {
    _TCPServer.begin(port);
}

bool RoveCommWifiTCP::read(RoveCommPacket &dest) {
    // reset packet
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void RoveCommWifiTCP::_writeReliable(const rovecomm::data_type_t dataType, const uint16_t dataId,
...
void RoveCommWifiTCP::_writeToReliable(const rovecomm::data_type_t dataType, const uint16_t dataId,
